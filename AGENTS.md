...
- Task end: dated summary ≤6 KB with the four sections, traps appended to `docs/agents/traps.md`, ≤900-char LATEST entry on top, oldest deleted. Skill: `umbra-session-end`; fresh session: `umbra-session-start`.
