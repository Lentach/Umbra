...
- NOT verified: the 4b late-open `storeOpened()` call (needs the 4 s budget; untested); no browser/APK drive (no user-visible surface yet); nothing sends into a request queue from app code until slice (f).
